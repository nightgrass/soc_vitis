...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ENABLE_READ" -parent ${optional}
  ipgui::add_param $IPINST -name "ENABLE_WRITE" -parent ${optional}
  ipgui::add_param $IPINST -name "VIDEO_ENABLE" -parent ${optional}
