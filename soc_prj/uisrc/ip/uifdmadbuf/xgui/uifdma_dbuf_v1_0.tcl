...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "R_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_BUFDEPTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_BUFSIZE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_DATAWIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_DSIZEBITS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_XDIV" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_XSIZE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_XSTRIDE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "R_YSIZE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "VIDEO_ENABLE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_BUFDEPTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_BUFSIZE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_DATAWIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_DSIZEBITS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_XDIV" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_XSIZE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "W_XSTRIDE" -parent ${Page_0}
