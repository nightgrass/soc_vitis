...
HD_PWD='I:/ISP_1x/ISP_4x/ui_awb_1_3V/ui_awb_1_3V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log awb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source awb.tcl
