...
#
# Generated by export_simulation on Thu Apr 24 10:23:29 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './div_gen_awb.sh' script.

./div_gen_awb.sh -reset_run
...
./div_gen_awb.sh -noclean_files

For more information on the script, please type './div_gen_awb.sh -help'.
