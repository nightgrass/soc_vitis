...
#
# Generated by export_simulation on Thu Apr 24 10:22:37 +0800 2025
#
################################################################################
...
./blk_mem_gen_awb_delay_signal.sh
...
'-reset_run' switch to the './blk_mem_gen_awb_delay_signal.sh' script.

./blk_mem_gen_awb_delay_signal.sh -reset_run
...
./blk_mem_gen_awb_delay_signal.sh -noclean_files

For more information on the script, please type './blk_mem_gen_awb_delay_signal.sh -help'.
