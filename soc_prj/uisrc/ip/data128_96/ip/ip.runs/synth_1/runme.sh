...
HD_PWD='E:/vlkus/fpag_image/ISP_four_data/data128_96/ip/ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data128_96.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data128_96.tcl
