...
HD_PWD='E:/vlkus/fpag_image/ISP_four_data/data128_96/ip/ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data128_96.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data128_96.tcl -notrace
