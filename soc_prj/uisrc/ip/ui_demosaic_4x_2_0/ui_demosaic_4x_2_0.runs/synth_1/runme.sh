...
HD_PWD='I:/ISP_1x/ISP_4x/ui_demosaic_4x_2_0/ui_demosaic_4x_2_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_demosaic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_demosaic.tcl
