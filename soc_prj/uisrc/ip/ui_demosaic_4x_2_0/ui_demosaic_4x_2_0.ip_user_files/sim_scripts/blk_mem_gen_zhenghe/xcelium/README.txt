...
#
# Generated by export_simulation on Fri Aug 01 17:07:12 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_zhenghe.sh' script.

./blk_mem_gen_zhenghe.sh -reset_run
...
./blk_mem_gen_zhenghe.sh -noclean_files

For more information on the script, please type './blk_mem_gen_zhenghe.sh -help'.
