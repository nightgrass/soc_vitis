...
HD_PWD='H:/ISP/isp_3_2_imx415_ku5p/isp_3_2_imx415_ku5p/soc_prj/uisrc/03_ip/ui_ISP/ui_imx415/ui_imx415.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imx415_AE_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imx415_AE_top.tcl
