...
HD_PWD='I:/ISP_1x/ISP_4x/ui_image_cut/ui_image_cut.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_cut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_cut.tcl
