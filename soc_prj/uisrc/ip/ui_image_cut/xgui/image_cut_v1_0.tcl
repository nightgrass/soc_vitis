...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Pixel_Per_Clock" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SKIP_COLS_left" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SKIP_COLS_right" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SKIP_ROWS_bottom" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SKIP_ROWS_top" -parent ${Page_0}
