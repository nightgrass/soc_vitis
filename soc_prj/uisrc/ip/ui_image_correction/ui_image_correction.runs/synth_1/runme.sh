...
HD_PWD='I:/ISP_1x/ISP_4x/ui_image_correction/ui_image_correction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_correction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_correction.tcl
