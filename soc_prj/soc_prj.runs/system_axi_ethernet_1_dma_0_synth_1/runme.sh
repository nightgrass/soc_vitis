...
HD_PWD='G:/proj/fpga/zynq7020_mlk2/proj/06_ex_linux_QT_Drive_L2_7020/QT_Drive_Appendix/project/soc_prj/soc_prj.runs/system_axi_ethernet_1_dma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_ethernet_1_dma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_ethernet_1_dma_0.tcl
