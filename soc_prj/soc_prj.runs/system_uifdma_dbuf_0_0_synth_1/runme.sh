...
HD_PWD='G:/proj/fpga/zynq7020_mlk2/proj/linux_QT/QT/project/soc_prj/soc_prj.runs/system_uifdma_dbuf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_uifdma_dbuf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_uifdma_dbuf_0_0.tcl
