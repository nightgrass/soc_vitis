...
XAxiDma_Config XAxiDma_ConfigTable[XPAR_XAXIDMA_NUM_INSTANCES] =
{
	...
	},
	{
		...
		XPAR_AXI_ETHERNET_1_DMA_BASEADDR,
		XPAR_AXI_ETHERNET_1_DMA_SG_INCLUDE_STSCNTRL_STRM,
		XPAR_AXI_ETHERNET_1_DMA_INCLUDE_MM2S,
		XPAR_AXI_ETHERNET_1_DMA_INCLUDE_MM2S_DRE,
		XPAR_AXI_ETHERNET_1_DMA_M_AXI_MM2S_DATA_WIDTH,
		XPAR_AXI_ETHERNET_1_DMA_INCLUDE_S2MM,
		XPAR_AXI_ETHERNET_1_DMA_INCLUDE_S2MM_DRE,
		XPAR_AXI_ETHERNET_1_DMA_M_AXI_S2MM_DATA_WIDTH,
		XPAR_AXI_ETHERNET_1_DMA_INCLUDE_SG,
		XPAR_AXI_ETHERNET_1_DMA_NUM_MM2S_CHANNELS,
		XPAR_AXI_ETHERNET_1_DMA_NUM_S2MM_CHANNELS,
		XPAR_AXI_ETHERNET_1_DMA_MM2S_BURST_SIZE,
		XPAR_AXI_ETHERNET_1_DMA_S2MM_BURST_SIZE,
		XPAR_AXI_ETHERNET_1_DMA_MICRO_DMA,
		XPAR_AXI_ETHERNET_1_DMA_ADDR_WIDTH,
		XPAR_AXI_ETHERNET_1_DMA_SG_LENGTH_WIDTH
	}
};
